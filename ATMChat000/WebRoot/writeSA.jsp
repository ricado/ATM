...
<body>
	<div>
		<div id="write">
			<div id="head">
				<form action="schoolActive/saveSchoolActive.do" enctype="multipart/form-data" method="Post"
					id="form_submit">
					<table>
						<tr>
							<th>标&nbsp;&nbsp;&nbsp;&nbsp;题:</th>
							...
							<th rowspan="3">
								...
								<img alt="选择图片" src="image/icon/iconfont-tupian.png" id="photo" class="opera_image"> 
								<input type="file" name="file" class="file">
								<input type="hidden" name="describe" id="describe">
								<input type="radio" name="isHeadNews" value="1">头条
								<input type="radio" name="isHeadNews" value="0">非头条
								</th>
						</tr>
						<tr>
							<th>副标题:</th>
			...
			<div id="content" contenteditable="true">
				5月28日，“金子之光”校友报告会第二十七场在教学实验中心大楼学</div>
			<div id="opera">
