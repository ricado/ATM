...
public class JpgThumbnail {
	...
	private static void thumbnailHandler(String source, String output,
		...
		try {
			...
			if (sourceFile.exists()) {
				...
				int theImgWidth = image.getWidth(null);// 宽度
				int theImgHeight = image.getHeight(null);// 高度
	...
	public static void BigImageToSmallImage(String bigPath, String smallPath) {
		getThumbnail(bigPath, smallPath, 250, 300);
	}

	public static void BigImageToSmallImage(String bigPath, String smallPath,
			int width, int height) {
		getThumbnail(bigPath, smallPath, width, height);
	}

	public static void main(String[] agrs) {
		// zoomPicture("E:\\1.jpg","E:\\test.jpg",60, 80);
		getThumbnail("F:/image/well.jpg", "G:/atm/555_small.jpg", 120, 160);
	}
