...
public class FeedbackDAOImpl implements FeedbackDAO  {
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.FeedbackDAO#setSessionFactory(org.hibernate.SessionFactory)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.FeedbackDAO#save(com.atm.model.Feedback)
	 */
    @Override
	...
	/* (non-Javadoc)
	 * @see com.atm.dao.FeedbackDAO#delete(com.atm.model.Feedback)
	 */
	@Override
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.FeedbackDAO#findById(java.lang.Integer)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.FeedbackDAO#findByExample(com.atm.model.Feedback)
	 */
    @Override
	public List findByExample(Feedback instance) {
        log.debug("finding Feedback instance by example");
        try {
            List results = getCurrentSession().createCriteria("com.atm.model.Feedback") .add(Example.create(instance)).list();
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.FeedbackDAO#findByProperty(java.lang.String, java.lang.Object)
	 */
    @Override
	...
	/* (non-Javadoc)
	 * @see com.atm.dao.FeedbackDAO#findByUserId(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.atm.dao.FeedbackDAO#findByFeeContent(java.lang.Object)
	 */
	@Override
	public List findByFeeContent(Object feeContent
	) {
		return findByProperty(FEE_CONTENT, feeContent
		);
	}
	

	/* (non-Javadoc)
	 * @see com.atm.dao.FeedbackDAO#findAll()
	 */
	@Override
	public List findAll() {
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.FeedbackDAO#merge(com.atm.model.Feedback)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.FeedbackDAO#attachDirty(com.atm.model.Feedback)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.FeedbackDAO#attachClean(com.atm.model.Feedback)
	 */
    @Override
	...
	public static FeedbackDAO getFromApplicationContext() {
    	return (FeedbackDAO) ApplicationUtil.getApplicationContext().getBean("FeedbackDAOImpl");
	}
	@Override
