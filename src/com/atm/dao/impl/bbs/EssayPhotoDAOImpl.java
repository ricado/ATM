 ...
 * 
 * @see com.atm.model.bbs.EssayPhoto
...
public class EssayPhotoDAOImpl implements EssayPhotoDAO {
	...
	/* (non-Javadoc)
	 * @see com.atm.dao.impl.EssayPhotoDAO#save(com.atm.model.bbs.EssayPhoto)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.atm.dao.impl.EssayPhotoDAO#delete(com.atm.model.bbs.EssayPhoto)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.atm.dao.impl.EssayPhotoDAO#findById(com.atm.model.bbs.EssayPhotoId)
	 */
	@Override
	public EssayPhoto findById(String id) {
		log.debug("getting EssayPhoto instance with id: " + id);
		try {
			EssayPhoto instance = (EssayPhoto) getCurrentSession().get(
					"com.atm.model.bbs.EssayPhoto", id);
			return instance;
		} catch (RuntimeException re) {
	...
	/* (non-Javadoc)
	 * @see com.atm.dao.impl.EssayPhotoDAO#findByExample(com.atm.model.bbs.EssayPhoto)
	 */
	@Override
	public List findByExample(EssayPhoto instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.atm.model.bbs.EssayPhoto")
	...
	/* (non-Javadoc)
	 * @see com.atm.dao.impl.EssayPhotoDAO#merge(com.atm.model.bbs.EssayPhoto)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.atm.dao.impl.EssayPhotoDAO#attachDirty(com.atm.model.bbs.EssayPhoto)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.atm.dao.impl.EssayPhotoDAO#attachClean(com.atm.model.bbs.EssayPhoto)
	 */
	@Override
