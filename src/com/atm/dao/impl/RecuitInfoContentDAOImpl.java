...
public class RecuitInfoContentDAOImpl implements RecuitInfoContentDAO  {
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.RecuitIinfoContentDAO#save(com.atm.model.RecuitInfoContent)
	 */
    @Override
	...
	/* (non-Javadoc)
	 * @see com.atm.dao.RecuitIinfoContentDAO#delete(com.atm.model.RecuitInfoContent)
	 */
	@Override
	...
	public RecuitInfoContent findById( java.lang.Integer id) {
        ...
        try {
            RecuitInfoContent instance = (RecuitInfoContent) getCurrentSession()
                    .get("com.atm.model.RecuitInfoContent", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.RecuitIinfoContentDAO#findByExample(com.atm.model.RecuitInfoContent)
	 */
    @Override
	public List findByExample(RecuitInfoContent instance) {
        log.debug("finding RecuitIinfoContent instance by example");
        try {
            List results = getCurrentSession().createCriteria("com.atm.model.RecuitInfoContent") .add(Example.create(instance)).list();
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.RecuitIinfoContentDAO#merge(com.atm.model.RecuitInfoContent)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.RecuitIinfoContentDAO#attachDirty(com.atm.model.RecuitInfoContent)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.RecuitIinfoContentDAO#attachClean(com.atm.model.RecuitInfoContent)
	 */
    @Override
