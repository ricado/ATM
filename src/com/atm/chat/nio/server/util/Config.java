...
public interface Config {
	...
	public static final int MYMESSAGE = 1154;// 我的消息

	public static final int AT_ME = 1155; // @我的

	public static final int SYSTEM_MESSAGE = 1156; // 系统消息

	public static final int REPLY_ME = 1157;// 回复我的
