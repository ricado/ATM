 ...
 */
document
		.write("<script language='javascript' src='jquery-2.1.1.min.js'></script>");
//document.write("<script language='javascript' src='pages.js'></script>");
...
$.getLoginList = function(i) {
	...
	if (params == false) {
		...
		$.sendAjax("page_loginList", params)
	}
}