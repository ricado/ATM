...
/**
	 ...
	 * @see com.atm.model.bbs.LabelAttentionAssociation
...
public class LabelAttentionAssociationDAOImpl implements LabelAttentionAssociationDAO  {
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.impl.LabelAttentionAssociationDAO#save(com.atm.model.bbs.LabelAttentionAssociation)
	 */
    @Override
	...
	/* (non-Javadoc)
	 * @see com.atm.dao.impl.LabelAttentionAssociationDAO#delete(com.atm.model.bbs.LabelAttentionAssociation)
	 */
	@Override
	...
	public LabelAttentionAssociation findById( com.atm.model.LabelAttentionAssociationId id) {
        ...
        try {
            LabelAttentionAssociation instance = (LabelAttentionAssociation) getCurrentSession()
                    .get("com.atm.model.bbs.LabelAttentionAssociation", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.impl.LabelAttentionAssociationDAO#findByExample(com.atm.model.bbs.LabelAttentionAssociation)
	 */
    @Override
	public List findByExample(LabelAttentionAssociation instance) {
        ...
        try {
            List results = getCurrentSession().createCriteria("com.atm.model.bbs.LabelAttentionAssociation") .add(Example.create(instance)).list();
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.impl.LabelAttentionAssociationDAO#merge(com.atm.model.bbs.LabelAttentionAssociation)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.impl.LabelAttentionAssociationDAO#attachDirty(com.atm.model.bbs.LabelAttentionAssociation)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.atm.dao.impl.LabelAttentionAssociationDAO#attachClean(com.atm.model.bbs.LabelAttentionAssociation)
	 */
    @Override
	...
	@Override
	public LabelAttentionAssociation haveAttend(Object userId, int labId) {
		 try {
	         String queryString = "from LabelAttentionAssociation as model where model.userId" 
	         						+ "=? and model.labId"
	         						+ "= ?";
	         Query queryObject = getCurrentSession().createQuery(queryString);
			 queryObject.setParameter(0, userId);
			 queryObject.setParameter(1, labId);
			return (LabelAttentionAssociation) queryObject.uniqueResult();
